...
class AssignmentStatementVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by AssignmentStatementParser#casest.
    def visitCasest(self, ctx:AssignmentStatementParser.CasestContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AssignmentStatementParser#casebody.
    def visitCasebody(self, ctx:AssignmentStatementParser.CasebodyContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by AssignmentStatementParser#simpletrn.
    def visitSimpletrn(self, ctx:AssignmentStatementParser.SimpletrnContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AssignmentStatementParser#trnbody.
    def visitTrnbody(self, ctx:AssignmentStatementParser.TrnbodyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AssignmentStatementParser#compoundtrn.
    def visitCompoundtrn(self, ctx:AssignmentStatementParser.CompoundtrnContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by AssignmentStatementParser#fact_string.
    def visitFact_string(self, ctx:AssignmentStatementParser.Fact_stringContext):
        return self.visitChildren(ctx)
